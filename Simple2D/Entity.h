...
enum EntityType { PLATFORM, PLAYER, ENEMY_JUMPER, TRAP, ENEMY, ENEMY_ROTATOR, ENEMY_FOLLOWER, ATTACK, CANNON };
...
public:
    ...
    void rot_right() { rocketAngle += 0.5f; }
    void set_angle(float angle) {rocketAngle = angle;}
    float get_angle() { return rocketAngle; }
